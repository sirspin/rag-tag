    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="max-w-broadsheet mx-auto px-6 md:px-12 py-20 md:py-28 text-center">
        ...
        <p className="font-lora text-lg md:text-xl text-text-secondary max-w-xl mx-auto mb-10 leading-relaxed">
          Ragtag is a living newspaper your people file stories to — beautiful, public, and always up to date.
        </p>
      ...
      <section className="max-w-broadsheet mx-auto px-6 md:px-12 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-0">
          {[
            {
              number: 'I.',
              heading: 'File stories anytime',
              body: 'Your staff reporters file links from the web, by SMS, or by email — articles, essays, anything worth reading. A quick note says what caught their eye.',
            },
            {
              number: 'II.',
              heading: 'The paper organizes itself',
              body: 'Stories appear the moment they come in. The AI arranges them into sections as they accumulate. No compile step, no publish button.',
            },
            {
              number: 'III.',
              heading: 'Always something to read',
              body: 'The paper lives at its own URL, public and readable anytime. Beautiful type, full bylines, real articles. A newspaper that\'s never out of date.',
            },
          ].map((step, i) => (
      ...
      <section className="max-w-broadsheet mx-auto px-6 md:px-12 py-16">
        <div className="text-center mb-10">
          <p className="section-header mb-3">What the paper looks like</p>
          <hr className="rule-thin max-w-xs mx-auto" />
        </div>
